...
\usepackage{hyperref}
\hypersetup{
            pdftitle={PRA2 - Tipología y ciclo de vida de dato},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df <-}\StringTok{ }\NormalTok{train_df[}\OperatorTok{-}\KeywordTok{which}\NormalTok{(train_df}\OperatorTok{$}\NormalTok{Age }\OperatorTok{%in%}\StringTok{ }\NormalTok{outlier_values),] }\CommentTok{# los eliminamos}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df <-}\StringTok{ }\NormalTok{train_df[}\OperatorTok{-}\KeywordTok{which}\NormalTok{(train_df}\OperatorTok{$}\NormalTok{Fare }\OperatorTok{%in%}\StringTok{ }\NormalTok{outlier_values),] }\CommentTok{# los eliminamos}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Creamos un nuevo conjunto de datos a partir del original (solo para esta prueba)}
\NormalTok{train_df_corr <-}\StringTok{ }\NormalTok{train_df}

\CommentTok{# Realizamos las modificaciones descritas anteriormente}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Sex[train_df_corr}\OperatorTok{$}\NormalTok{Sex}\OperatorTok{==}\StringTok{'male'}\NormalTok{] <-}\StringTok{ }\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Sex[train_df_corr}\OperatorTok{$}\NormalTok{Sex}\OperatorTok{==}\StringTok{'female'}\NormalTok{] <-}\StringTok{ }\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Embarked[train_df_corr}\OperatorTok{$}\NormalTok{Embarked}\OperatorTok{==}\StringTok{'C'}\NormalTok{] <-}\StringTok{ }\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Embarked[train_df_corr}\OperatorTok{$}\NormalTok{Embarked}\OperatorTok{==}\StringTok{'Q'}\NormalTok{] <-}\StringTok{ }\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Embarked[train_df_corr}\OperatorTok{$}\NormalTok{Embarked}\OperatorTok{==}\StringTok{'S'}\NormalTok{] <-}\StringTok{ }\DecValTok{2}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Survived <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Survived)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Pclass <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Pclass)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Sex <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Sex)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Age <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Age)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{SibSp <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{SibSp)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Parch <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Parch)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Fare <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Fare)}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Embarked <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(train_df_corr}\OperatorTok{$}\NormalTok{Embarked)}

\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{Cabin <-}\StringTok{ }\OtherTok{NULL}
\NormalTok{train_df_corr}\OperatorTok{$}\NormalTok{PassengerId <-}\StringTok{ }\OtherTok{NULL}

\KeywordTok{head}\NormalTok{(train_df_corr, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
