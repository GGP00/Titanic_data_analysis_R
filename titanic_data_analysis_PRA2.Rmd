...
También hay algún atributo que debería ser numérico y es categórico, como es el caso del Ticket. Podríamos asumir que se trata del identificador del tripulante y que no contiene otro tipo de información deducible o complementaria, más allá del orden de compra del ticket, lo cual, dificilmente interviene en la supervivencia del pasajero. Además, ya tenemos un ID por lo que prescindiremos del atributo.
